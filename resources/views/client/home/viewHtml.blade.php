        ...
        <div class="modal-content card">
            ...
            <div class="modal-body pt-1">
                <div style="padding: 0px 10px 10px 10px;display:flex">
                    <div style="width:30%;">
                        <img style="width:80%;padding:20px 0px 0px 20px" class="card-img " src="../clients/img/logo.png" alt="Card image">
                    </div>
                ...
                <div>
                    <br>
                    <center>
                        <span style="font-size: 20px;font-weight: 700;">PHIẾU KẾT QUẢ CỘNG HƯỞNG TỪ</span>
                    </center>
                    <br>
                </div>
                <div>
