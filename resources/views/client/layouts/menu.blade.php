...
<nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow" style="top:0;padding-top:0px !important;padding-bottom: 0px !important;background:#ffffff!important;width: 100%;z-index: 1000;">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="image-logo" style="width:15%">
            <img style="padding:10px" class="card-img " src="../clients/img/logo.png" alt="Card image">
        </div>
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
            <div class="flex-fill mx-xl-2">
                ...
                <ul class="nav navbar-nav d-flex justify-content-between mx-xl-2 text-center text-dark" style="width:700px">
                    <li class="nav-item">
                        <a class="nav-link link-home btn-outline-info rounded-pill" href="{{ url('/') }}"> <span class="text-menu-header"> <i class="fas fa-home"></i> Phòng khám Meditec </span> <br> <span class="text-12"></span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-bloodtest btn-outline-info rounded-pill" href="{{ url('/client/appointmentathome/indexApointment') }}"> <span class="text-menu-header"><i class="fas fa-tint"></i> Dịch vụ phòng khám</span> <br> <span class="text-12"></span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-infusion btn-outline-info rounded-pill" href="{{ url('/client/appointmentathome/indexInfusion') }}"> <span class="text-menu-header"><i class="fas fa-thermometer"></i> Giấy phép hoạt động</span> <br> <span class="text-12"></span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-infusion btn-outline-info rounded-pill" href="{{ url('/client/appointmentathome/indexInfusion') }}"> <span class="text-menu-header"><i class="fas fa-search-plus"></i> Tra cứu kết quả</span> <br> <span class="text-12"></span> </a>
                    </li>
                    <!-- <li class="nav-item">
